                    ...
                    <tr>
                        <td style="background-color:#ffffff;border:1px solid #e4e4e7;border-radius:16px;padding:36px 32px;">
                                ...
                                <tr>
                                    <td style="padding:8px 20px 20px;">
                                        @foreach ([
                                            ...
                                            <p style="margin:2px 0 0;font-family:{{ $font }};font-size:15px;font-weight:600;color:#18181b;text-decoration:line-through;text-decoration-color:#d4d4d8;">
                                                {{ $value }}
                                            </p>
                                        @endforeach
                                    </td>
                            ...
                            <p style="margin:24px 0 0;font-family:{{ $font }};font-size:14px;line-height:1.6;color:#3f3f46;">
                                {{ __('Changed your mind? You can book a new appointment at any time.') }}
                            </p>

                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:16px;">
                                <tr>
                                    <td align="center" style="border-radius:10px;background-color:#0063ff;">
                                        <a href="{{ $bookingUrl }}" target="_blank" style="display:block;padding:14px 24px;font-family:{{ $font }};font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">
                                            {{ __('Book again') }}
                                        </a>
                                    </td>
                                </tr>
