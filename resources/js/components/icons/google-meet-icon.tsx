/**
 * The Google Meet logo as an inline SVG, so an online appointment can be marked
 * with the recognisable multicolour glyph anywhere a meeting link exists. Sizing
 * follows the surrounding text: set `className` to a `size-*` utility.
 */
