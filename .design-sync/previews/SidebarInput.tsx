    ...
    return (
        <SidebarProvider>
            ...
            <SidebarHeader>
                ...
                <SidebarInput defaultValue="Gel man" />
            </SidebarHeader>
                <SidebarContent>
                <SidebarGroup>
            ...
            <Workspace title="Services" />
        </SidebarProvider>
    );
}

export function FilterInsideAGroup() {
    return (
        <SidebarProvider>
            <Sidebar collapsible="icon" variant="inset">
            <SidebarHeader>
                ...
                <SidebarGroup>
                    ...
                    <SidebarGroupContent className="space-y-2">
                        <SidebarInput placeholder="Filter specialists…" />
                        <SidebarMenu>
                            <SidebarMenuItem>
                                <SidebarMenuButton isActive>
                                    <Users />
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton>
                                    <Users />
                                    <span>Kamran Hasanov</span>
                                </SidebarMenuButton>
                            </SidebarMenuItem>
                            <SidebarMenuItem>
                                <SidebarMenuButton>
                                    <Users />
                                    <span>Nigar Aliyeva</span>
                                </SidebarMenuButton>
                            </SidebarMenuItem>
                        </SidebarMenu>
                    </SidebarGroupContent>
